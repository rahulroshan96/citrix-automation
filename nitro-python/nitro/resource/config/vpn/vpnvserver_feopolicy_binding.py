...
class vpnvserver_feopolicy_binding(base_resource) :
    ...
    def get(cls, service, name) :
        """Use this API to fetch vpnvserver_feopolicy_binding resources.
    ...
    def get_filtered(cls, service, name, filter_) :
        """Use this API to fetch filtered set of vpnvserver_feopolicy_binding resources.
    ...
    def count(cls, service, name) :
        """Use this API to count vpnvserver_feopolicy_binding resources configued on NetScaler.
    ...
    def count_filtered(cls, service, name, filter_) :
        """Use this API to count the filtered set of vpnvserver_feopolicy_binding resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
