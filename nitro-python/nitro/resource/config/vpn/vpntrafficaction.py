...
class vpntrafficaction(base_resource) :
    ...
    @property
    def qual(self) :
        """Protocol, either HTTP or TCP, to be used with the action.<br/>Possible values = http, tcp."""
        try :
            return self._qual
        except Exception as e:
            raise e
    ...
    @property
    def hdx(self) :
        """Provide hdx proxy to the ICA traffic.<br/>Possible values = ON, OFF."""
        try :
            return self._hdx
        except Exception as e:
            raise e
    ...
    @property
    def kcdaccount(self) :
        """Kerberos constrained delegation account name.<br/>Default value: "Default"<br/>Minimum length =  1<br/>Maximum length =  32."""
        try :
