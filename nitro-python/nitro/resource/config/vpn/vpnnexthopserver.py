...
class vpnnexthopserver(base_resource) :
    ...
    def nexthopfqdn(self) :
        """FQDN of the NetScaler Gateway proxy in the second DMZ.<br/>Minimum length =  1."""
        try :
    ...
    def resaddresstype(self) :
        """Address Type (IPV4/IPv6) of DNS name of nextHopServer FQDN.<br/>Minimum length =  1<br/>Possible values = IPV4, IPV6."""
        try :
