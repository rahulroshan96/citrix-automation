...
class vpnglobal_intranetip6_binding(base_resource) :
    ...
    @classmethod
    def get(cls, service) :
        """Use this API to fetch a vpnglobal_intranetip6_binding resources.
    ...
    def get_filtered(cls, service, filter_) :
        """Use this API to fetch filtered set of vpnglobal_intranetip6_binding resources.
    ...
    def count(cls, service) :
        """Use this API to count vpnglobal_intranetip6_binding resources configued on NetScaler.
    ...
    def count_filtered(cls, service, filter_) :
        """Use this API to count the filtered set of vpnglobal_intranetip6_binding resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
