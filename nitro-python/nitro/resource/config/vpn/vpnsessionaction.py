...
class vpnsessionaction(base_resource) :
    ...
    def rdpclientprofilename(self) :
        """Name of the RDP profile associated with the vserver.<br/>Minimum length =  1<br/>Maximum length =  31."""
        try :
    ...
    def iconwithreceiver(self) :
        """Option to decide whether to show plugin icon along with receiver.<br/>Possible values = ON, OFF."""
        try :
