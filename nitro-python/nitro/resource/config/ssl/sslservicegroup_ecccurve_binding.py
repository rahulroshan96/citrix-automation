...
class sslservicegroup_ecccurve_binding(base_resource) :
    ...
    def ecccurvename(self) :
        """Named ECC curve bound to servicegroup.<br/>Possible values = ALL, P_224, P_256, P_384, P_521."""
        try :
    ...
    def get(cls, service, servicegroupname) :
        """Use this API to fetch sslservicegroup_ecccurve_binding resources.
    ...
    def get_filtered(cls, service, servicegroupname, filter_) :
        """Use this API to fetch filtered set of sslservicegroup_ecccurve_binding resources.
    ...
    def count(cls, service, servicegroupname) :
        """Use this API to count sslservicegroup_ecccurve_binding resources configued on NetScaler.
    ...
    def count_filtered(cls, service, servicegroupname, filter_) :
        """Use this API to count the filtered set of sslservicegroup_ecccurve_binding resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
