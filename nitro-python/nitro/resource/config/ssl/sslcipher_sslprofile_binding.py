...
class sslcipher_sslprofile_binding(base_resource) :
    ...
    def get(cls, service, ciphergroupname) :
        """Use this API to fetch sslcipher_sslprofile_binding resources.
    ...
    def get_filtered(cls, service, ciphergroupname, filter_) :
        """Use this API to fetch filtered set of sslcipher_sslprofile_binding resources.
    ...
    def count(cls, service, ciphergroupname) :
        """Use this API to count sslcipher_sslprofile_binding resources configued on NetScaler.
    ...
    def count_filtered(cls, service, ciphergroupname, filter_) :
        """Use this API to count the filtered set of sslcipher_sslprofile_binding resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
