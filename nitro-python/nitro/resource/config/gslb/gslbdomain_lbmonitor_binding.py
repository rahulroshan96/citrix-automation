...
class gslbdomain_lbmonitor_binding(base_resource) :
    ...
    @property
    def iptunnel(self) :
        """The state of the monitor for tunneled devices.<br/>Possible values = YES, NO."""
        try :
    ...
    @property
    def monstate(self) :
        """Monitor state.<br/>Possible values = UP, DOWN, UNKNOWN, BUSY, OUT OF SERVICE, GOING OUT OF SERVICE, DOWN WHEN GOING OUT OF SERVICE, NS_EMPTY_STR, Unknown, DISABLED."""
        try :
    ...
    def get(cls, service, name) :
        """Use this API to fetch gslbdomain_lbmonitor_binding resources.
    ...
    def get_filtered(cls, service, name, filter_) :
        """Use this API to fetch filtered set of gslbdomain_lbmonitor_binding resources.
    ...
    def count(cls, service, name) :
        """Use this API to count gslbdomain_lbmonitor_binding resources configued on NetScaler.
    ...
    def count_filtered(cls, service, name, filter_) :
        """Use this API to count the filtered set of gslbdomain_lbmonitor_binding resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
