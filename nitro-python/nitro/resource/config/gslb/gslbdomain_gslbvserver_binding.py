...
class gslbdomain_gslbvserver_binding(base_resource) :
    ...
    def backuplbmethod(self) :
        """Indicates the backup method in case the primary fails.<br/>Possible values = ROUNDROBIN, LEASTCONNECTION, LEASTRESPONSETIME, SOURCEIPHASH, LEASTBANDWIDTH, LEASTPACKETS, STATICPROXIMITY, RTT, CUSTOMLOAD."""
        try :
    ...
    @property
    def lbmethod(self) :
        """The load balancing method set for the virtual server.<br/>Possible values = ROUNDROBIN, LEASTCONNECTION, LEASTRESPONSETIME, SOURCEIPHASH, LEASTBANDWIDTH, LEASTPACKETS, STATICPROXIMITY, RTT, CUSTOMLOAD."""
        try :
    ...
    @property
    def cip(self) :
        """Indicates if Client IP option is enabled.<br/>Possible values = ENABLED, DISABLED."""
        try :
            return self._cip
        except Exception as e:
            raise e
    ...
    def dnsrecordtype(self) :
        """The IP type for this GSLB vserver.<br/>Possible values = A, AAAA, CNAME, NAPTR."""
        try :
    ...
    def sitepersistence(self) :
        """Indicates the type of cookie persistence set.<br/>Possible values = ConnectionProxy, HTTPRedirect, NONE."""
        try :
    ...
    def servicetype(self) :
        """The type GSLB service.<br/>Possible values = HTTP, FTP, TCP, UDP, SSL, SSL_BRIDGE, SSL_TCP, NNTP, ANY, SIP_UDP, SIP_TCP, SIP_SSL, RADIUS, RDP, RTSP, MYSQL, MSSQL, ORACLE."""
        try :
    ...
    def persistencetype(self) :
        """Indicates if persistence is set on the gslb vserver.<br/>Possible values = SOURCEIP, NONE."""
        try :
    ...
    def dynamicweight(self) :
        """Dynamic weight method of the vserver.<br/>Default value: DISABLED<br/>Possible values = SERVICECOUNT, SERVICEWEIGHT, DISABLED."""
        try :
    ...
    def get(cls, service, name) :
        """Use this API to fetch gslbdomain_gslbvserver_binding resources.
    ...
    def get_filtered(cls, service, name, filter_) :
        """Use this API to fetch filtered set of gslbdomain_gslbvserver_binding resources.
    ...
    def count(cls, service, name) :
        """Use this API to count gslbdomain_gslbvserver_binding resources configued on NetScaler.
    ...
    def count_filtered(cls, service, name, filter_) :
        """Use this API to count the filtered set of gslbdomain_gslbvserver_binding resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
