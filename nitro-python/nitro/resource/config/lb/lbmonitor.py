...
class lbmonitor(base_resource) :
    ...
    @property
    def type(self) :
        """Type of monitor that you want to create.<br/>Possible values = PING, TCP, HTTP, TCP-ECV, HTTP-ECV, UDP-ECV, DNS, FTP, LDNS-PING, LDNS-TCP, LDNS-DNS, RADIUS, USER, HTTP-INLINE, SIP-UDP, SIP-TCP, LOAD, FTP-EXTENDED, SMTP, SNMP, NNTP, MYSQL, MYSQL-ECV, MSSQL-ECV, ORACLE-ECV, LDAP, POP3, CITRIX-XML-SERVICE, CITRIX-WEB-INTERFACE, DNS-TCP, RTSP, ARP, CITRIX-AG, CITRIX-AAC-LOGINPAGE, CITRIX-AAC-LAS, CITRIX-XD-DDC, ND6, CITRIX-WI-EXTENDED, DIAMETER, RADIUS_ACCOUNTING, STOREFRONT, APPC, SMPP, CITRIX-XNC-ECV, CITRIX-XDM."""
        try :
            return self._type
        except Exception as e:
            raise e
    ...
    def mssqlprotocolversion(self) :
        """Version of MSSQL server that is to be monitored.<br/>Default value: 70<br/>Possible values = 70, 2000, 2000SP1, 2005, 2008, 2008R2, 2012, 2014."""
        try :
    ...
    def storefrontcheckbackendservices(self) :
        """This option will enable monitoring of services running on storefront server. Storefront services are monitored by probing to a Windows service that runs on the Storefront server and exposes details of which storefront services are running.<br/>Default value: NO<br/>Possible values = YES, NO."""
        try :
    ...
    def storefrontcheckbackendservices(self, storefrontcheckbackendservices) :
        ...
        :param storefrontcheckbackendservices: 
