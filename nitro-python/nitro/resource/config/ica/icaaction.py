...
class icaaction(base_resource) :
    ...
    @property
    def builtin(self) :
        """Indicates that the ICA action is a built-in (SYSTEM INTERNAL) type.<br/>Possible values = MODIFIABLE, DELETABLE, IMMUTABLE, PARTITION_ALL."""
        try :
    ...
    def delete(cls, client, resource) :
        """Use this API to delete icaaction.
    ...
    def update(cls, client, resource) :
        """Use this API to update icaaction.
    ...
    def rename(cls, client, resource, new_name) :
        """Use this API to rename a icaaction resource.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the icaaction resources that are configured on netscaler.
    ...
    def get_filtered(cls, client, filter_) :
        """Use this API to fetch filtered set of icaaction resources.
    ...
    def count(cls, client) :
        """Use this API to count the icaaction resources configured on NetScaler.
    ...
    def count_filtered(cls, client, filter_) :
        """Use this API to count filtered the set of icaaction resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
