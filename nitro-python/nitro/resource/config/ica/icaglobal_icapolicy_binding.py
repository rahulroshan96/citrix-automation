...
class icaglobal_icapolicy_binding(base_resource) :
    ...
    @property
    def type(self) :
        """Global bind point for which to show detailed information about the policies bound to the bind point.<br/>Possible values = ICA_REQ_OVERRIDE, ICA_REQ_DEFAULT."""
        try :
            return self._type
        except Exception as e:
            raise e
    ...
    @classmethod
    def get(cls, service) :
        """Use this API to fetch a icaglobal_icapolicy_binding resources.
    ...
    def get_filtered(cls, service, filter_) :
        """Use this API to fetch filtered set of icaglobal_icapolicy_binding resources.
    ...
    def count(cls, service) :
        """Use this API to count icaglobal_icapolicy_binding resources configued on NetScaler.
    ...
    def count_filtered(cls, service, filter_) :
        """Use this API to count the filtered set of icaglobal_icapolicy_binding resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
