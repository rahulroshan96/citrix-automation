...
class csvserver_domain_binding(base_resource) :
    ...
    def cookietimeout(self) :
        """.<br/>Minimum value =  0<br/>Maximum value =  1440."""
        try :
    ...
    def get(cls, service, name) :
        """Use this API to fetch csvserver_domain_binding resources.
    ...
    def get_filtered(cls, service, name, filter_) :
        """Use this API to fetch filtered set of csvserver_domain_binding resources.
    ...
    def count(cls, service, name) :
        """Use this API to count csvserver_domain_binding resources configued on NetScaler.
    ...
    def count_filtered(cls, service, name, filter_) :
        """Use this API to count the filtered set of csvserver_domain_binding resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
