...
class lsnrtspalgsession(base_resource) :
    ...
    def flush(cls, client, resource) :
        """Use this API to flush lsnrtspalgsession.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the lsnrtspalgsession resources that are configured on netscaler.
    ...
    def get_filtered(cls, client, filter_) :
        """Use this API to fetch filtered set of lsnrtspalgsession resources.
    ...
    def count(cls, client) :
        """Use this API to count the lsnrtspalgsession resources configured on NetScaler.
    ...
    def count_filtered(cls, client, filter_) :
        """Use this API to count filtered the set of lsnrtspalgsession resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
