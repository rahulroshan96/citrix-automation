...
class lsnsipalgcall_datachannel_binding(base_resource) :
    ...
    def get(cls, service, callid) :
        """Use this API to fetch lsnsipalgcall_datachannel_binding resources.
    ...
    def get_filtered(cls, service, callid, filter_) :
        """Use this API to fetch filtered set of lsnsipalgcall_datachannel_binding resources.
    ...
    def count(cls, service, callid) :
        """Use this API to count lsnsipalgcall_datachannel_binding resources configued on NetScaler.
