...
class lsntransportprofile(base_resource) :
    ...
    def transportprotocol(self) :
        """Protocol for which to set the LSN transport profile parameters.<br/>Possible values = TCP, UDP, ICMP."""
        try :
    ...
    def stuntimeout(self) :
        """STUN protocol timeout.<br/>Default value: 600<br/>Minimum length =  120<br/>Maximum length =  1200."""
        try :
    ...
    def synidletimeout(self) :
        """SYN Idle timeout.<br/>Default value: 60<br/>Minimum length =  30<br/>Maximum length =  120."""
        try :
    ...
    def add(cls, client, resource) :
        """Use this API to add lsntransportprofile.
    ...
    def delete(cls, client, resource) :
        """Use this API to delete lsntransportprofile.
    ...
    def update(cls, client, resource) :
        """Use this API to update lsntransportprofile.
    ...
    def unset(cls, client, resource, args) :
        """Use this API to unset the properties of lsntransportprofile resource.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the lsntransportprofile resources that are configured on netscaler.
    ...
    def get_filtered(cls, client, filter_) :
        """Use this API to fetch filtered set of lsntransportprofile resources.
    ...
    def count(cls, client) :
        """Use this API to count the lsntransportprofile resources configured on NetScaler.
    ...
    def count_filtered(cls, client, filter_) :
        """Use this API to count filtered the set of lsntransportprofile resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
