...
class lsnpool(base_resource) :
    ...
    def delete(cls, client, resource) :
        """Use this API to delete lsnpool.
    ...
    def update(cls, client, resource) :
        """Use this API to update lsnpool.
    ...
    def unset(cls, client, resource, args) :
        """Use this API to unset the properties of lsnpool resource.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the lsnpool resources that are configured on netscaler.
    ...
    def get_filtered(cls, client, filter_) :
        """Use this API to fetch filtered set of lsnpool resources.
    ...
    def count(cls, client) :
        """Use this API to count the lsnpool resources configured on NetScaler.
    ...
    def count_filtered(cls, client, filter_) :
        """Use this API to count filtered the set of lsnpool resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
