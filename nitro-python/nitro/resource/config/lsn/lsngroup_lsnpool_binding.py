...
class lsngroup_lsnpool_binding(base_resource) :
    ...
    def get(cls, service, groupname) :
        """Use this API to fetch lsngroup_lsnpool_binding resources.
    ...
    def get_filtered(cls, service, groupname, filter_) :
        """Use this API to fetch filtered set of lsngroup_lsnpool_binding resources.
    ...
    def count(cls, service, groupname) :
        """Use this API to count lsngroup_lsnpool_binding resources configued on NetScaler.
    ...
    def count_filtered(cls, service, groupname, filter_) :
        """Use this API to count the filtered set of lsngroup_lsnpool_binding resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
