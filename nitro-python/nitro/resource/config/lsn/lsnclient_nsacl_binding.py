...
class lsnclient_nsacl_binding(base_resource) :
    ...
    def get(cls, service, clientname) :
        """Use this API to fetch lsnclient_nsacl_binding resources.
    ...
    def get_filtered(cls, service, clientname, filter_) :
        """Use this API to fetch filtered set of lsnclient_nsacl_binding resources.
    ...
    def count(cls, service, clientname) :
        """Use this API to count lsnclient_nsacl_binding resources configued on NetScaler.
    ...
    def count_filtered(cls, service, clientname, filter_) :
        """Use this API to count the filtered set of lsnclient_nsacl_binding resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
