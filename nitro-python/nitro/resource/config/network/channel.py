...
class channel(base_resource) :
    ...
    @property
    def reqspeed(self) :
        """Requested speed setting for this channel. Since no media are associated with LA, this speed is used to determine the threshold for the slave interfaces. If the speed of the member interface is less than the requested speed, that interface is considered inactive.<br/>Possible values = AUTO, 10, 100, 1000, 10000, 40000."""
        try :
    ...
    @property
    def actspeed(self) :
        """Actual speed setting for this channel.<br/>Possible values = AUTO, 10, 100, 1000, 10000, 40000."""
        try :
