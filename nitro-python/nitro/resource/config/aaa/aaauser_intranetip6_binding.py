...
class aaauser_intranetip6_binding(base_resource) :
    ...
    def get(cls, service, username) :
        """Use this API to fetch aaauser_intranetip6_binding resources.
    ...
    def get_filtered(cls, service, username, filter_) :
        """Use this API to fetch filtered set of aaauser_intranetip6_binding resources.
    ...
    def count(cls, service, username) :
        """Use this API to count aaauser_intranetip6_binding resources configued on NetScaler.
    ...
    def count_filtered(cls, service, username, filter_) :
        """Use this API to count the filtered set of aaauser_intranetip6_binding resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
