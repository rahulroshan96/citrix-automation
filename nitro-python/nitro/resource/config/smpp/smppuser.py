...
class smppuser(base_resource) :
    ...
    @property
    def username(self) :
        """Name of the SMPP user. Must be the same as the user name specified in the SMPP server.<br/>Minimum length =  1."""
        try :
    ...
    @property
    def password(self) :
        """Password for binding to the SMPP server. Must be the same as the password specified in the SMPP server.<br/>Minimum length =  1."""
        try :
    ...
    def delete(cls, client, resource) :
        """Use this API to delete smppuser.
    ...
    def update(cls, client, resource) :
        """Use this API to update smppuser.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the smppuser resources that are configured on netscaler.
    ...
    def get_filtered(cls, client, filter_) :
        """Use this API to fetch filtered set of smppuser resources.
    ...
    def count(cls, client) :
        """Use this API to count the smppuser resources configured on NetScaler.
    ...
    def count_filtered(cls, client, filter_) :
        """Use this API to count filtered the set of smppuser resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
