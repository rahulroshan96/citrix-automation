...
class subscribersessions(base_resource) :
    ...
    def clear(cls, client, resource) :
        """Use this API to clear subscribersessions.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the subscribersessions resources that are configured on netscaler.
    ...
    def get_filtered(cls, client, filter_) :
        """Use this API to fetch filtered set of subscribersessions resources.
    ...
    def count(cls, client) :
        """Use this API to count the subscribersessions resources configured on NetScaler.
    ...
    def count_filtered(cls, client, filter_) :
        """Use this API to count filtered the set of subscribersessions resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
