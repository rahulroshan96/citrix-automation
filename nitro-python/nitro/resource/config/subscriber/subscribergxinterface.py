...
class subscribergxinterface(base_resource) :
    ...
    def requestretryattempts(self) :
        """If the request does not complete within requestTimeout time, the request is retransmitted for requestRetryAttempts time.<br/>Default value: 3."""
        try :
    ...
    def servicepathavp(self) :
        """The AVP code in which PCRF sends service path applicable for subscriber.<br/>Minimum length =  1."""
        try :
    ...
    @property
    def svrstate(self) :
        """The state of the gx service.<br/>Possible values = UP, DOWN, UNKNOWN, BUSY, OUT OF SERVICE, GOING OUT OF SERVICE, DOWN WHEN GOING OUT OF SERVICE, NS_EMPTY_STR, Unknown, DISABLED."""
        try :
    ...
    def update(cls, client, resource) :
        """Use this API to update subscribergxinterface.
    ...
    def unset(cls, client, resource, args) :
        """Use this API to unset the properties of subscribergxinterface resource.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the subscribergxinterface resources that are configured on netscaler.
