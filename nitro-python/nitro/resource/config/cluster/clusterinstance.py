...
class clusterinstance(base_resource) :
    ...
    def deadinterval(self) :
        """Amount of time, in seconds, after which nodes that do not respond to the heartbeats are assumed to be down.If the value is less than 3 sec, set the helloInterval parameter to 200 msec.<br/>Default value: 3<br/>Minimum length =  1<br/>Maximum length =  60."""
        try :
    ...
    def hellointerval(self) :
        """Interval, in milliseconds, at which heartbeats are sent to each cluster node to check the health status.Set the value to 200 msec, if the deadInterval parameter is less than 3 sec.<br/>Default value: 200<br/>Minimum length =  200<br/>Maximum length =  1000."""
        try :
    ...
    @property
    def inc(self) :
        """This option is required if the cluster nodes reside on different networks.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED."""
        try :
            return self._inc
        except Exception as e:
            raise e
    ...
    def processlocal(self) :
        """By turning on this option packets destined to a service in a cluster will not under go any steering.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED."""
        try :
