...
class clusternode(base_resource) :
    ...
    @property
    def nodegroup(self) :
        """The default node group in a Cluster system.<br/>Default value: DEFAULT_NG<br/>Minimum length =  1."""
        try :
    ...
    def clearnodegroupconfig(self) :
        """Option to remove nodegroup config.<br/>Default value: YES<br/>Possible values = YES, NO."""
        try :
    ...
    @property
    def name(self) :
        """Name of the state specific nodegroup.<br/>Minimum length =  1."""
        try :
            return self._name
        except Exception as e:
            raise e
