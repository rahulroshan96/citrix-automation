...
class nsservicefunction(base_resource) :
    ...
    def servicefunctionname(self) :
        """Name of the service function to be created. Leading character must be a number or letter. Other characters allowed, after the first character, are @ _ - . (period) : (colon) # and space ( ).<br/>Minimum length =  1."""
        try :
    ...
    def ingressvlan(self) :
        """VLAN ID on which the traffic from service function reaches Netscaler.<br/>Minimum length =  1<br/>Maximum length =  4094."""
        try :
    ...
    def add(cls, client, resource) :
        """Use this API to add nsservicefunction.
    ...
    def update(cls, client, resource) :
        """Use this API to update nsservicefunction.
    ...
    def delete(cls, client, resource) :
        """Use this API to delete nsservicefunction.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the nsservicefunction resources that are configured on netscaler.
    ...
    def get_filtered(cls, client, filter_) :
        """Use this API to fetch filtered set of nsservicefunction resources.
    ...
    def count(cls, client) :
        """Use this API to count the nsservicefunction resources configured on NetScaler.
    ...
    def count_filtered(cls, client, filter_) :
        """Use this API to count filtered the set of nsservicefunction resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
