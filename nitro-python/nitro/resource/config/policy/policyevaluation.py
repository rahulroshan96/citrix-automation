...
class policyevaluation(base_resource) :
    ...
    def pitoperationperformerarray(self) :
        """Details of the operation NS performed at various offsets during applying of rewrite action on input data. Operation can be insertion, modfication or deletion.<br/>Possible values = INSERT, MODIFY, DELETE."""
        try :
