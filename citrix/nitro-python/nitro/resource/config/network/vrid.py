...
class vrid(base_resource) :
    ...
    @property
    def priority(self) :
        """Base priority (BP), in an active-active mode configuration, which ordinarily determines the master VIP address.<br/>Default value: 255<br/>Maximum length =  255."""
        try :
    ...
    def trackifnumpriority(self) :
        """Priority by which the Effective priority will be reduced if any of the tracked interfaces goes down.<br/>Default value: 0<br/>Minimum length =  1<br/>Maximum length =  255."""
        try :
    ...
    def preemptiondelaytimer(self) :
        """Preemption delay time in seconds. If any high priority node will come in network, it will wait for these many seconds before becoming master.<br/>Default value: 0<br/>Minimum length =  1<br/>Maximum length =  36000."""
        try :
