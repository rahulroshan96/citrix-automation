...
class Interface(base_resource) :
    ...
    def lacppriority(self) :
        """LACP port priority, expressed as an integer. The lower the number, the higher the priority. The NetScaler appliance limits the number of interfaces in an LA channel to sixteen.<br/>Default value: 32768<br/>Minimum length =  1<br/>Maximum length =  65535."""
        try :
    ...
    def lrsetpriority(self) :
        """LRSET port priority, expressed as an integer ranging from 1 to 1024. The highest priority is 1. The NetScaler limits the number of interfaces in an LRSET to 8. Within a LRSET the highest LR Priority Interface is considered as the first candidate for the Active interface, if the interface is UP.<br/>Default value: 1024<br/>Minimum length =  1<br/>Maximum length =  1024."""
        try :
    ...
    @property
    def reqspeed(self) :
        """Requested speed setting for this interface.<br/>Possible values = AUTO, 10, 100, 1000, 10000, 40000."""
        try :
    ...
    @property
    def actspeed(self) :
        """Actual speed setting for this interface.<br/>Possible values = AUTO, 10, 100, 1000, 10000, 40000."""
        try :
