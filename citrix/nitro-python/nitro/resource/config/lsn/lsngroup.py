...
class lsngroup(base_resource) :
    ...
    def snmptraplimit(self) :
        """Maximum number of SNMP Trap messages that can be generated for the LSN group in one minute.<br/>Default value: 100<br/>Maximum length =  10000."""
        try :
    ...
    @property
    def pptp(self) :
        """Enable the PPTP Application Layer Gateway.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED."""
        try :
            return self._pptp
        except Exception as e:
            raise e
    ...
    @property
    def sipalg(self) :
        """Enable the SIP ALG.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED."""
        try :
            return self._sipalg
        except Exception as e:
            raise e
    ...
    @property
    def rtspalg(self) :
        """Enable the RTSP ALG.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED."""
        try :
    ...
    def delete(cls, client, resource) :
        """Use this API to delete lsngroup.
    ...
    def update(cls, client, resource) :
        """Use this API to update lsngroup.
    ...
    def unset(cls, client, resource, args) :
        """Use this API to unset the properties of lsngroup resource.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the lsngroup resources that are configured on netscaler.
    ...
    def get_filtered(cls, client, filter_) :
        """Use this API to fetch filtered set of lsngroup resources.
    ...
    def count(cls, client) :
        """Use this API to count the lsngroup resources configured on NetScaler.
    ...
    def count_filtered(cls, client, filter_) :
        """Use this API to count filtered the set of lsngroup resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
