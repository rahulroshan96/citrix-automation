...
class lsnclient_network6_binding(base_resource) :
    ...
    @property
    def network6(self) :
        """IPv6 address(es) of the LSN subscriber(s) or subscriber network(s) on whose traffic you want the NetScaler ADC to perform Large Scale NAT.<br/>Minimum length =  1."""
        try :
    ...
    def get(cls, service, clientname) :
        """Use this API to fetch lsnclient_network6_binding resources.
    ...
    def get_filtered(cls, service, clientname, filter_) :
        """Use this API to fetch filtered set of lsnclient_network6_binding resources.
    ...
    def count(cls, service, clientname) :
        """Use this API to count lsnclient_network6_binding resources configued on NetScaler.
    ...
    def count_filtered(cls, service, clientname, filter_) :
        """Use this API to count the filtered set of lsnclient_network6_binding resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
