...
class lsnip6profile(base_resource) :
    ...
    @property
    def type(self) :
        """IPv6 translation type for which to set the LSN IP6 profile parameters.<br/>Possible values = DS-Lite."""
        try :
            return self._type
        except Exception as e:
            raise e
    ...
    def add(cls, client, resource) :
        """Use this API to add lsnip6profile.
    ...
    def delete(cls, client, resource) :
        """Use this API to delete lsnip6profile.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the lsnip6profile resources that are configured on netscaler.
    ...
    def get_filtered(cls, client, filter_) :
        """Use this API to fetch filtered set of lsnip6profile resources.
    ...
    def count(cls, client) :
        """Use this API to count the lsnip6profile resources configured on NetScaler.
    ...
    def count_filtered(cls, client, filter_) :
        """Use this API to count filtered the set of lsnip6profile resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
