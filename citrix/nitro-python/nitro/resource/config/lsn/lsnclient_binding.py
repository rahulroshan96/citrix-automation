...
class lsnclient_binding(base_resource):
    ...
    def lsnclient_nsacl6_bindings(self) :
        """nsacl6 that can be bound to lsnclient."""
        try :
    ...
    def lsnclient_network_bindings(self) :
        """network that can be bound to lsnclient."""
        try :
    ...
    def lsnclient_nsacl_bindings(self) :
        """nsacl that can be bound to lsnclient."""
        try :
    ...
    def lsnclient_network6_bindings(self) :
        """network6 that can be bound to lsnclient."""
        try :
    ...
    def get(self, service, clientname) :
        """Use this API to fetch lsnclient_binding resource.
