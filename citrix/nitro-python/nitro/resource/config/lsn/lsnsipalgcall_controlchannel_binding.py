...
class lsnsipalgcall_controlchannel_binding(base_resource) :
    ...
    def get(cls, service, callid) :
        """Use this API to fetch lsnsipalgcall_controlchannel_binding resources.
    ...
    def get_filtered(cls, service, callid, filter_) :
        """Use this API to fetch filtered set of lsnsipalgcall_controlchannel_binding resources.
    ...
    def count(cls, service, callid) :
        """Use this API to count lsnsipalgcall_controlchannel_binding resources configued on NetScaler.
    ...
    def count_filtered(cls, service, callid, filter_) :
        """Use this API to count the filtered set of lsnsipalgcall_controlchannel_binding resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
