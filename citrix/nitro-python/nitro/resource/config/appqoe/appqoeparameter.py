...
class appqoeparameter(base_resource) :
    ...
    def dosattackthresh(self) :
        """average number of client connection that can queue up on vserver level without triggering DoS mitigation module.<br/>Default value: 2000<br/>Maximum length =  0xFFFFFFFE."""
        try :
