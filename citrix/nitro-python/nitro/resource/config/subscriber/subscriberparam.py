...
class subscriberparam(base_resource) :
    ...
    @property
    def keytype(self) :
        """Type of subscriber key type IP or IPANDVLAN.<br/>Default value: IP<br/>Possible values = IP."""
        try :
    ...
    def ipv6prefixlookuplist(self) :
        """The ipv6PrefixLookupList should consist of all the ipv6 prefix lengths assigned to the UE's'.<br/>Minimum length =  1<br/>Maximum length =  128."""
        try :
    ...
    def update(cls, client, resource) :
        """Use this API to update subscriberparam.
    ...
    def unset(cls, client, resource, args) :
        """Use this API to unset the properties of subscriberparam resource.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the subscriberparam resources that are configured on netscaler.
