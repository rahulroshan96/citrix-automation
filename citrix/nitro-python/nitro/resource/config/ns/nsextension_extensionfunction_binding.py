...
class nsextension_extensionfunction_binding(base_resource) :
    ...
    @property
    def name(self) :
        """Name of the extension object.<br/>Minimum length =  1<br/>Maximum length =  31."""
        try :
            return self._name
    ...
    def extensionfunctionname(self) :
        """Name of extension function given in the extension.<br/>Minimum length =  1<br/>Maximum length =  31."""
        try :
    ...
    def extensionfunctionclasstype(self) :
        """Extension function class type.<br/>Minimum length =  1<br/>Maximum length =  31."""
        try :
    ...
    def extensionfuncdescription(self) :
        """Any description to preserve information about the extension function.<br/>Maximum length =  1023."""
        try :
    ...
    def extensionfunctionreturntype(self) :
        """Extension function return type.<br/>Minimum length =  1<br/>Maximum length =  31."""
        try :
    ...
    def get(cls, service, name) :
        """Use this API to fetch nsextension_extensionfunction_binding resources.
    ...
    def get_filtered(cls, service, name, filter_) :
        """Use this API to fetch filtered set of nsextension_extensionfunction_binding resources.
    ...
    def count(cls, service, name) :
        """Use this API to count nsextension_extensionfunction_binding resources configued on NetScaler.
    ...
    def count_filtered(cls, service, name, filter_) :
        """Use this API to count the filtered set of nsextension_extensionfunction_binding resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
