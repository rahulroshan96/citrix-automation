...
class nslicenseproxyserver(base_resource) :
    ...
    @property
    def serverip(self) :
        """IP address of the License proxy server.<br/>Minimum length =  1."""
        try :
    ...
    def add(cls, client, resource) :
        """Use this API to add nslicenseproxyserver.
    ...
    def delete(cls, client, resource) :
        """Use this API to delete nslicenseproxyserver.
    ...
    def update(cls, client, resource) :
        """Use this API to update nslicenseproxyserver.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the nslicenseproxyserver resources that are configured on netscaler.
    ...
    def get_filtered(cls, client, filter_) :
        """Use this API to fetch filtered set of nslicenseproxyserver resources.
    ...
    def count(cls, client) :
        """Use this API to count the nslicenseproxyserver resources configured on NetScaler.
    ...
    def count_filtered(cls, client, filter_) :
        """Use this API to count filtered the set of nslicenseproxyserver resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
