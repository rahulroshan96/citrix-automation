...
class nsservicepath(base_resource) :
    ...
    def add(cls, client, resource) :
        """Use this API to add nsservicepath.
    ...
    def delete(cls, client, resource) :
        """Use this API to delete nsservicepath.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the nsservicepath resources that are configured on netscaler.
    ...
    def get_filtered(cls, client, filter_) :
        """Use this API to fetch filtered set of nsservicepath resources.
    ...
    def count(cls, client) :
        """Use this API to count the nsservicepath resources configured on NetScaler.
    ...
    def count_filtered(cls, client, filter_) :
        """Use this API to count filtered the set of nsservicepath resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
