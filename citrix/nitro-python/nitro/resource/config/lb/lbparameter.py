...
class lbparameter(base_resource) :
    ...
    def usesecuredpersistencecookie(self) :
        """Encode persistence cookie values using SHA2 hash.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED."""
        try :
    ...
    def usesecuredpersistencecookie(self, usesecuredpersistencecookie) :
        ...
        :param usesecuredpersistencecookie: 
    ...
    def retainservicestate(self) :
        """This option is used to retain the original state of service or servicegroup member when an enable server command is issued.<br/>Default value: OFF<br/>Possible values = ON, OFF."""
        try :
