...
class authenticationldapaction(base_resource) :
    ...
    def referraldnslookup(self) :
        """Specifies the DNS Record lookup Type for the referrals.<br/>Default value: A-REC<br/>Possible values = A-REC, SRV-REC, MSSRV-REC."""
        try :
