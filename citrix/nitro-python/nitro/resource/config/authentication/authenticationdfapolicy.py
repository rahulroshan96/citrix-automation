...
class authenticationdfapolicy(base_resource) :
    ...
    @property
    def action(self) :
        """Name of the DFA action to perform if the policy matches.<br/>Minimum length =  1."""
        try :
            return self._action
        except Exception as e:
            raise e
    ...
    def add(cls, client, resource) :
        """Use this API to add authenticationdfapolicy.
    ...
    def delete(cls, client, resource) :
        """Use this API to delete authenticationdfapolicy.
    ...
    def update(cls, client, resource) :
        """Use this API to update authenticationdfapolicy.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the authenticationdfapolicy resources that are configured on netscaler.
    ...
    def get_filtered(cls, client, filter_) :
        """Use this API to fetch filtered set of authenticationdfapolicy resources.
    ...
    def count(cls, client) :
        """Use this API to count the authenticationdfapolicy resources configured on NetScaler.
    ...
    def count_filtered(cls, client, filter_) :
        """Use this API to count filtered the set of authenticationdfapolicy resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
