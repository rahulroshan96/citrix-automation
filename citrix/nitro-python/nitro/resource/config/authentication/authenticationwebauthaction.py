...
class authenticationwebauthaction(base_resource) :
    ...
    @property
    def attribute1(self) :
        """Expression that would be evaluated to extract attribute1 from the webauth response.<br/>Maximum length =  128."""
        try :
    ...
    @property
    def attribute2(self) :
        """Expression that would be evaluated to extract attribute2 from the webauth response.<br/>Maximum length =  128."""
        try :
    ...
    @property
    def attribute3(self) :
        """Expression that would be evaluated to extract attribute3 from the webauth response.<br/>Maximum length =  128."""
        try :
    ...
    @property
    def attribute4(self) :
        """Expression that would be evaluated to extract attribute4 from the webauth response.<br/>Maximum length =  128."""
        try :
    ...
    @property
    def attribute5(self) :
        """Expression that would be evaluated to extract attribute5 from the webauth response.<br/>Maximum length =  128."""
        try :
    ...
    @property
    def attribute6(self) :
        """Expression that would be evaluated to extract attribute6 from the webauth response.<br/>Maximum length =  128."""
        try :
    ...
    @property
    def attribute7(self) :
        """Expression that would be evaluated to extract attribute7 from the webauth response.<br/>Maximum length =  128."""
        try :
    ...
    @property
    def attribute8(self) :
        """Expression that would be evaluated to extract attribute8 from the webauth response.<br/>Maximum length =  128."""
        try :
    ...
    @property
    def attribute9(self) :
        """Expression that would be evaluated to extract attribute9 from the webauth response.<br/>Maximum length =  128."""
        try :
    ...
    def attribute10(self) :
        """Expression that would be evaluated to extract attribute10 from the webauth response.<br/>Maximum length =  128."""
        try :
    ...
    def attribute11(self) :
        """Expression that would be evaluated to extract attribute11 from the webauth response.<br/>Maximum length =  128."""
        try :
    ...
    def attribute12(self) :
        """Expression that would be evaluated to extract attribute12 from the webauth response.<br/>Maximum length =  128."""
        try :
    ...
    def attribute13(self) :
        """Expression that would be evaluated to extract attribute13 from the webauth response.<br/>Maximum length =  128."""
        try :
    ...
    def attribute14(self) :
        """Expression that would be evaluated to extract attribute14 from the webauth response.<br/>Maximum length =  128."""
        try :
    ...
    def attribute15(self) :
        """Expression that would be evaluated to extract attribute15 from the webauth response.<br/>Maximum length =  128."""
        try :
    ...
    def attribute16(self) :
        """Expression that would be evaluated to extract attribute16 from the webauth response.<br/>Maximum length =  128."""
        try :
