...
class authenticationloginschemapolicy(base_resource) :
    ...
    @property
    def builtin(self) :
        """Flag to determine if policy is built-in or not.<br/>Possible values = MODIFIABLE, DELETABLE, IMMUTABLE, PARTITION_ALL."""
        try :
    ...
    def add(cls, client, resource) :
        """Use this API to add authenticationloginschemapolicy.
    ...
    def delete(cls, client, resource) :
        """Use this API to delete authenticationloginschemapolicy.
    ...
    def update(cls, client, resource) :
        """Use this API to update authenticationloginschemapolicy.
    ...
    def unset(cls, client, resource, args) :
        """Use this API to unset the properties of authenticationloginschemapolicy resource.
    ...
    def rename(cls, client, resource, new_name) :
        """Use this API to rename a authenticationloginschemapolicy resource.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the authenticationloginschemapolicy resources that are configured on netscaler.
    ...
    def get_filtered(cls, client, filter_) :
        """Use this API to fetch filtered set of authenticationloginschemapolicy resources.
    ...
    def count(cls, client) :
        """Use this API to count the authenticationloginschemapolicy resources configured on NetScaler.
    ...
    def count_filtered(cls, client, filter_) :
        """Use this API to count filtered the set of authenticationloginschemapolicy resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
