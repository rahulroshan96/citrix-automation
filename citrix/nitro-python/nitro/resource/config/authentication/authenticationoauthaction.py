...
class authenticationoauthaction(base_resource) :
    ...
    def add(cls, client, resource) :
        """Use this API to add authenticationoauthaction.
    ...
    def delete(cls, client, resource) :
        """Use this API to delete authenticationoauthaction.
    ...
    def update(cls, client, resource) :
        """Use this API to update authenticationoauthaction.
    ...
    def unset(cls, client, resource, args) :
        """Use this API to unset the properties of authenticationoauthaction resource.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the authenticationoauthaction resources that are configured on netscaler.
    ...
    def get_filtered(cls, client, filter_) :
        """Use this API to fetch filtered set of authenticationoauthaction resources.
    ...
    def count(cls, client) :
        """Use this API to count the authenticationoauthaction resources configured on NetScaler.
    ...
    def count_filtered(cls, client, filter_) :
        """Use this API to count filtered the set of authenticationoauthaction resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
