...
class authenticationloginschema(base_resource) :
    ...
    def userexpression(self) :
        """Expression for username extraction during login.<br/>Minimum length =  1."""
        try :
    ...
    def passwdexpression(self) :
        """Expression for password extraction during login.<br/>Minimum length =  1."""
        try :
    ...
    def usercredentialindex(self) :
        """The index at which user entered username should be stored in session.<br/>Minimum length =  1<br/>Maximum length =  16."""
        try :
    ...
    def passwordcredentialindex(self) :
        """The index at which user entered password should be stored in session.<br/>Minimum length =  1<br/>Maximum length =  16."""
        try :
    ...
    def authenticationstrength(self) :
        """Weight of the current authentication.<br/>Maximum length =  65535."""
        try :
    ...
    def add(cls, client, resource) :
        """Use this API to add authenticationloginschema.
    ...
    def delete(cls, client, resource) :
        """Use this API to delete authenticationloginschema.
    ...
    def update(cls, client, resource) :
        """Use this API to update authenticationloginschema.
    ...
    def unset(cls, client, resource, args) :
        """Use this API to unset the properties of authenticationloginschema resource.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the authenticationloginschema resources that are configured on netscaler.
    ...
    def get_filtered(cls, client, filter_) :
        """Use this API to fetch filtered set of authenticationloginschema resources.
    ...
    def count(cls, client) :
        """Use this API to count the authenticationloginschema resources configured on NetScaler.
    ...
    def count_filtered(cls, client, filter_) :
        """Use this API to count filtered the set of authenticationloginschema resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
