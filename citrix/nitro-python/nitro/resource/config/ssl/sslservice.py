...
class sslservice(base_resource) :
    ...
    def dtlsprofilename(self) :
        """Name of the DTLS profile that contains DTLS settings for the service.<br/>Minimum length =  1<br/>Maximum length =  127."""
        try :
    ...
    @property
    def sslprofile(self) :
        """Name of the SSL profile that contains SSL settings for the service.<br/>Minimum length =  1<br/>Maximum length =  127."""
        try :
