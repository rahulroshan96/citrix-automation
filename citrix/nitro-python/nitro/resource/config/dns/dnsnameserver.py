...
class dnsnameserver(base_resource) :
    ...
    def dnsprofilename(self) :
        """Name of the DNS profile to be associated with the name server.<br/>Minimum length =  1."""
        try :
    ...
    def update(cls, client, resource) :
        """Use this API to update dnsnameserver.
    ...
    def unset(cls, client, resource, args) :
        """Use this API to unset the properties of dnsnameserver resource.
