...
class aaagroup_intranetip6_binding(base_resource) :
    ...
    def get(cls, service, groupname) :
        """Use this API to fetch aaagroup_intranetip6_binding resources.
    ...
    def get_filtered(cls, service, groupname, filter_) :
        """Use this API to fetch filtered set of aaagroup_intranetip6_binding resources.
    ...
    def count(cls, service, groupname) :
        """Use this API to count aaagroup_intranetip6_binding resources configued on NetScaler.
    ...
    def count_filtered(cls, service, groupname, filter_) :
        """Use this API to count the filtered set of aaagroup_intranetip6_binding resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
