...
class gslbsite(base_resource) :
    ...
    def naptrreplacementsuffix(self) :
        """The naptr replacement suffix configured here will be used to construct the naptr replacement field in NAPTR record.<br/>Minimum length =  1."""
        try :
