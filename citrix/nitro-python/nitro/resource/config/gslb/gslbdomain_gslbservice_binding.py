...
class gslbdomain_gslbservice_binding(base_resource) :
    ...
    @property
    def weight(self) :
        """weight assigned.<br/>Minimum value =  1<br/>Maximum value =  100."""
        try :
            return self._weight
        except Exception as e:
            raise e
    ...
    @property
    def port(self) :
        """Port Number.<br/>Minimum value =  1<br/>Range 1 - 65535."""
        try :
            return self._port
        except Exception as e:
            raise e
    ...
    def svreffgslbstate(self) :
        """GSLB server state.<br/>Possible values = UP, DOWN, UNKNOWN, BUSY, OUT OF SERVICE, GOING OUT OF SERVICE, DOWN WHEN GOING OUT OF SERVICE, NS_EMPTY_STR, Unknown, DISABLED."""
        try :
    ...
    def get(cls, service, name) :
        """Use this API to fetch gslbdomain_gslbservice_binding resources.
    ...
    def get_filtered(cls, service, name, filter_) :
        """Use this API to fetch filtered set of gslbdomain_gslbservice_binding resources.
    ...
    def count(cls, service, name) :
        """Use this API to count gslbdomain_gslbservice_binding resources configued on NetScaler.
    ...
    def count_filtered(cls, service, name, filter_) :
        """Use this API to count the filtered set of gslbdomain_gslbservice_binding resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
