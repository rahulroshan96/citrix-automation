...
class icaaccessprofile(base_resource) :
    ...
    def connectclientlptports(self) :
        """Allow Default access/Disable automatic connection of LPT ports from the client when the user logs on.<br/>Default value: DISABLED<br/>Possible values = DEFAULT, DISABLED."""
        try :
    ...
    def clientaudioredirection(self) :
        """Allow Default access/Disable applications hosted on the server to play sounds through a sound device installed on the client computer, also allows or prevents users to record audio input.<br/>Default value: DISABLED<br/>Possible values = DEFAULT, DISABLED."""
        try :
    ...
    def localremotedatasharing(self) :
        """Allow Default access/Disable file/data sharing via the Reciever for HTML5.<br/>Default value: DISABLED<br/>Possible values = DEFAULT, DISABLED."""
        try :
    ...
    def clientclipboardredirection(self) :
        """Allow Default access/Disable the clipboard on the client device to be mapped to the clipboard on the server.<br/>Default value: DISABLED<br/>Possible values = DEFAULT, DISABLED."""
        try :
    ...
    def clientclipboardredirection(self, clientclipboardredirection) :
        ...
        :param clientclipboardredirection: 
    ...
    def clientcomportredirection(self) :
        """Allow Default access/Disable COM port redirection to and from the client.<br/>Default value: DISABLED<br/>Possible values = DEFAULT, DISABLED."""
        try :
    ...
    def clientcomportredirection(self, clientcomportredirection) :
        ...
        :param clientcomportredirection: 
    ...
    def clientdriveredirection(self) :
        """Allow Default access/Disables drive redirection to and from the client.<br/>Default value: DISABLED<br/>Possible values = DEFAULT, DISABLED."""
        try :
    ...
    def clientprinterredirection(self) :
        """Allow Default access/Disable client printers to be mapped to a server when a user logs on to a session.<br/>Default value: DISABLED<br/>Possible values = DEFAULT, DISABLED."""
        try :
    ...
    def clientprinterredirection(self, clientprinterredirection) :
        ...
        :param clientprinterredirection: 
    ...
    def multistream(self) :
        """Allow Default access/Disable the multistream feature for the specified users.<br/>Default value: DISABLED<br/>Possible values = DEFAULT, DISABLED."""
        try :
    ...
    def clientusbdriveredirection(self) :
        """Allow Default access/Disable the redirection of USB devices to and from the client.<br/>Default value: DISABLED<br/>Possible values = DEFAULT, DISABLED."""
        try :
    ...
    def clientusbdriveredirection(self, clientusbdriveredirection) :
        ...
        :param clientusbdriveredirection: 
    ...
    @property
    def builtin(self) :
        """Indicates that the ICA accessprofile is a built-in (SYSTEM INTERNAL) type.<br/>Possible values = MODIFIABLE, DELETABLE, IMMUTABLE, PARTITION_ALL."""
        try :
    ...
    def add(cls, client, resource) :
        """Use this API to add icaaccessprofile.
    ...
    def delete(cls, client, resource) :
        """Use this API to delete icaaccessprofile.
    ...
    def update(cls, client, resource) :
        """Use this API to update icaaccessprofile.
    ...
    def unset(cls, client, resource, args) :
        """Use this API to unset the properties of icaaccessprofile resource.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the icaaccessprofile resources that are configured on netscaler.
    ...
    def get_filtered(cls, client, filter_) :
        """Use this API to fetch filtered set of icaaccessprofile resources.
    ...
    def count(cls, client) :
        """Use this API to count the icaaccessprofile resources configured on NetScaler.
    ...
    def count_filtered(cls, client, filter_) :
        """Use this API to count filtered the set of icaaccessprofile resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
