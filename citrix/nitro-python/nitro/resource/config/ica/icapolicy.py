...
class icapolicy(base_resource) :
    ...
    @property
    def builtin(self) :
        """Indicates that the ICA policy is a built-in (SYSTEM INTERNAL) type.<br/>Possible values = MODIFIABLE, DELETABLE, IMMUTABLE, PARTITION_ALL."""
        try :
    ...
    def delete(cls, client, resource) :
        """Use this API to delete icapolicy.
    ...
    def update(cls, client, resource) :
        """Use this API to update icapolicy.
    ...
    def unset(cls, client, resource, args) :
        """Use this API to unset the properties of icapolicy resource.
    ...
    def rename(cls, client, resource, new_name) :
        """Use this API to rename a icapolicy resource.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the icapolicy resources that are configured on netscaler.
    ...
    def get_filtered(cls, client, filter_) :
        """Use this API to fetch filtered set of icapolicy resources.
    ...
    def count(cls, client) :
        """Use this API to count the icapolicy resources configured on NetScaler.
    ...
    def count_filtered(cls, client, filter_) :
        """Use this API to count filtered the set of icapolicy resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
