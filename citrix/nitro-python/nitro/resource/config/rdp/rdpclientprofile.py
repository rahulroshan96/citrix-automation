...
class rdpclientprofile(base_resource) :
    ...
    @property
    def name(self) :
        """The name of the rdp profile.<br/>Minimum length =  1."""
        try :
            return self._name
    ...
    def rdpurloverride(self) :
        """This setting determines whether the RDP parameters supplied in the vpn url override those specified in the RDP profile.<br/>Default value: ENABLE<br/>Possible values = ENABLE, DISABLE."""
        try :
    ...
    def redirectclipboard(self) :
        """This setting corresponds to the Clipboard check box on the Local Resources tab under Options in RDC.<br/>Default value: ENABLE<br/>Possible values = ENABLE, DISABLE."""
        try :
    ...
    def redirectdrives(self) :
        """This setting corresponds to the selections for Drives under More on the Local Resources tab under Options in RDC.<br/>Default value: DISABLE<br/>Possible values = ENABLE, DISABLE."""
        try :
    ...
    def redirectprinters(self) :
        """This setting corresponds to the selection in the Printers check box on the Local Resources tab under Options in RDC.<br/>Default value: ENABLE<br/>Possible values = ENABLE, DISABLE."""
        try :
    ...
    def redirectcomports(self) :
        """This setting corresponds to the selections for comports under More on the Local Resources tab under Options in RDC.<br/>Default value: DISABLE<br/>Possible values = ENABLE, DISABLE."""
        try :
    ...
    def redirectpnpdevices(self) :
        """This setting corresponds to the selections for pnpdevices under More on the Local Resources tab under Options in RDC.<br/>Default value: DISABLE<br/>Possible values = ENABLE, DISABLE."""
        try :
    ...
    def keyboardhook(self) :
        """This setting corresponds to the selection in the Keyboard drop-down list on the Local Resources tab under Options in RDC.<br/>Default value: InFullScreenMode<br/>Possible values = OnLocal, OnRemote, InFullScreenMode."""
        try :
    ...
    def audiocapturemode(self) :
        """This setting corresponds to the selections in the Remote audio area on the Local Resources tab under Options in RDC.<br/>Default value: DISABLE<br/>Possible values = ENABLE, DISABLE."""
        try :
    ...
    def videoplaybackmode(self) :
        """This setting determines if Remote Desktop Connection (RDC) will use RDP efficient multimedia streaming for video playback.<br/>Default value: ENABLE<br/>Possible values = ENABLE, DISABLE."""
        try :
    ...
    def multimonitorsupport(self) :
        """Enable/Disable Multiple Monitor Support for Remote Desktop Connection (RDC).<br/>Default value: ENABLE<br/>Possible values = ENABLE, DISABLE."""
        try :
    ...
    def rdpcookievalidity(self) :
        """RDP cookie validity period.<br/>Default value: 60<br/>Minimum length =  60<br/>Maximum length =  86400."""
        try :
    ...
    def addusernameinrdpfile(self) :
        """Add username in rdp file.<br/>Default value: NO<br/>Possible values = YES, NO."""
        try :
    ...
    def rdpfilename(self) :
        """RDP file name to be sent to End User.<br/>Minimum length =  1."""
        try :
    ...
    @property
    def rdphost(self) :
        """Fully-qualified domain name (FQDN) of the RDP Listener.<br/>Maximum length =  252."""
        try :
    ...
    def rdpcustomparams(self) :
        """Option for RDP custom parameters settings (if any). Custom params needs to be separated by '&'.<br/>Default value: 0<br/>Minimum length =  1."""
        try :
    ...
    @property
    def psk(self) :
        """Pre shared key value.<br/>Default value: 0."""
        try :
            return self._psk
        except Exception as e:
            raise e
    ...
    def add(cls, client, resource) :
        """Use this API to add rdpclientprofile.
    ...
    def update(cls, client, resource) :
        """Use this API to update rdpclientprofile.
    ...
    def unset(cls, client, resource, args) :
        """Use this API to unset the properties of rdpclientprofile resource.
    ...
    def delete(cls, client, resource) :
        """Use this API to delete rdpclientprofile.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the rdpclientprofile resources that are configured on netscaler.
    ...
    def get_filtered(cls, client, filter_) :
        """Use this API to fetch filtered set of rdpclientprofile resources.
    ...
    def count(cls, client) :
        """Use this API to count the rdpclientprofile resources configured on NetScaler.
    ...
    def count_filtered(cls, client, filter_) :
        """Use this API to count filtered the set of rdpclientprofile resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
