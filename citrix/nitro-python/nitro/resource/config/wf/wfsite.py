...
class wfsite(base_resource) :
    ...
    @property
    def sitename(self) :
        """Name of the WebFront site being created on the NetScaler appliance.<br/>Minimum length =  1<br/>Maximum length =  255."""
        try :
    ...
    def storefronturl(self) :
        """FQDN or IP of Windows StoreFront server where the store is configured.<br/>Minimum length =  1<br/>Maximum length =  255."""
        try :
    ...
    @property
    def storename(self) :
        """Name of the store present in StoreFront.<br/>Minimum length =  1<br/>Maximum length =  255."""
        try :
    ...
    def html5receiver(self) :
        """Specifies whether or not to use HTML5 receiver for launching apps for the WF site.<br/>Default value: FALLBACK<br/>Possible values = ALWAYS, FALLBACK, OFF."""
        try :
    ...
    def workspacecontrol(self) :
        """Specifies whether of not to use workspace control for the WF site.<br/>Default value: ON<br/>Possible values = ON, OFF."""
        try :
    ...
    def displayroamingaccounts(self) :
        """Specifies whether or not to display the accounts selection screen during First Time Use of Receiver .<br/>Default value: ON<br/>Possible values = ON, OFF."""
        try :
    ...
    def xframeoptions(self) :
        """The value to be sent in the X-Frame-Options header. WARNING: Setting this option to ALLOW could leave the end user vulnerable to Click Jacking attacks.<br/>Default value: DENY<br/>Possible values = ALLOW, DENY."""
        try :
    ...
    @property
    def state(self) :
        """State of wf site.<br/>Default value: UP<br/>Possible values = UP, INITIALIZING, DOWN-HostUnknown, DOWN-ReqTimeout, DOWN-Wrong Store, DOWN-SF Error, DOWN-SSL Error, DOWN-Conn Reset, DOWN."""
        try :
            return self._state
        except Exception as e:
            raise e
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the wfsite resources that are configured on netscaler.
    ...
    def get_filtered(cls, client, filter_) :
        """Use this API to fetch filtered set of wfsite resources.
    ...
    def count(cls, client) :
        """Use this API to count the wfsite resources configured on NetScaler.
    ...
    def count_filtered(cls, client, filter_) :
        """Use this API to count filtered the set of wfsite resources.
        Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
