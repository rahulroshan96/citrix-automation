...
class vpnvserver(base_resource) :
    ...
    @property
    def port(self) :
        """TCP port on which the virtual server listens.<br/>Range 1 - 65535."""
        try :
            return self._port
        except Exception as e:
            raise e
    ...
    def icaproxysessionmigration(self, icaproxysessionmigration) :
        ...
        :param icaproxysessionmigration: 
    ...
    @property
    def dtls(self) :
        """This option starts/stops the turn service on the vserver.<br/>Default value: OFF<br/>Possible values = ON, OFF."""
        try :
            return self._dtls
        except Exception as e:
            raise e
    ...
    @property
    def loginonce(self) :
        """This option enables/disables seamless SSO for this Vserver.<br/>Default value: OFF<br/>Possible values = ON, OFF."""
        try :
    ...
    def httpprofilename(self) :
        """Name of the HTTP profile to assign to this virtual server.<br/>Default value: "nshttp_default_strict_validation"<br/>Minimum length =  1<br/>Maximum length =  127."""
        try :
    ...
    def rdpserverprofilename(self) :
        """Name of the RDP server profile associated with the vserver.<br/>Minimum length =  1<br/>Maximum length =  31."""
        try :
    ...
    def windowsepapluginupgrade(self) :
        """Option to set plugin upgrade behaviour for Win.<br/>Possible values = Always, Essential, Never."""
        try :
    ...
    def linuxepapluginupgrade(self) :
        """Option to set plugin upgrade behaviour for Linux.<br/>Possible values = Always, Essential, Never."""
        try :
    ...
    def macepapluginupgrade(self) :
        """Option to set plugin upgrade behaviour for Mac.<br/>Possible values = Always, Essential, Never."""
        try :
