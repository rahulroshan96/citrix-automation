...
class systemsshkey(base_resource) :
    ...
    def delete(cls, client, resource) :
        """Use this API to delete systemsshkey.
    ...
    def Import(cls, client, resource) :
        """Use this API to Import systemsshkey.
    ...
    def get(cls, client, name="", option_="") :
        """Use this API to fetch all the systemsshkey resources that are configured on netscaler.
