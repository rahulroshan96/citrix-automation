...
class sslvserver_stats(base_resource) :
    ...
    def vservername(self) :
        """Name of the SSL virtual server for which to show detailed statistics.<br/>Minimum length =  1."""
        try :
    ...
    def  get(cls, service, name="", option_="") :
        """Use this API to fetch the statistics of all sslvserver_stats resources that are configured on netscaler.
